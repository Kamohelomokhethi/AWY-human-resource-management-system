    ...
    <div className='body'>
      <nav id="sidebar">
        <ul>
          ...
          <li>
            <button onClick={() => toggleSubMenu('staffInfo')} 
            
           // className="dropdown-btn" //first bug
            className={`dropdown-btn ${subMenuOpen.staffInfo ? "rotate" : ""}`}
          ...
          <li><Link to="/delete-member">Delete Member</Link></li>
          <li><Link to="/search-member">Search Member</Link></li>
                </div>
              </ul>
            )}
          </li>
          <li>
            <button onClick={() => toggleSubMenu('professionalDev')} 
            //</li>className="dropdown-btn">
            className={`dropdown-btn ${subMenuOpen.professionalDev ? "rotate" : ""}`}>
            ...
            {subMenuOpen.professionalDev && (
              <ul 
              className={`sub-menu ${subMenuOpen.professionalDev ? "show" : ""}`}>
                <div>
                  <li><Link to={"/Track-dev"}>Track Dev</Link></li>
                  <li><Link to={"/Training-schedule"}>Training Schedule</Link></li>
                  <li><Link to={"Points-overview"}>Points Overview</Link></li>
                </div>
              </ul>
            )}
          </li>
          <li>
            <button onClick={() => toggleSubMenu('procurement')} 
            //</li>className="dropdown-btn">
            className={`dropdown-btn ${subMenuOpen.procurement ? "rotate" : ""}`}>
